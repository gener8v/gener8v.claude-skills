...
Do not modify any source file — the plugin's hooks refuse a write outside `.gener8v/`, and send you back if a shell command changed one. Do not modify the delivery record. Your only write is the review report.
